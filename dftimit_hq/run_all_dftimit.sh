...
for file in "${files[@]}"; do
    ...
    python deepfake_detector/dfdetector.py --benchmark True --data_path /home/tianlong/Downloads/dftimit/DeepfakeTIMIT --detection_method "$name" --dataset dftimit_hq > "dftimit_hq_${name}.txt"
done
