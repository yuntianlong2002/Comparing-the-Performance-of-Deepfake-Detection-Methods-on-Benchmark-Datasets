...
six_method_ensemble_uadfv.pth
six_method_ensemble_celebdf.pth
six_method_ensemble_dftimit_hq.pth
six_method_ensemble_dftimit_lq.pth
...
for file in "${files[@]}"; do
    ...
    python ../deepfake_detector/dfdetector.py --benchmark True --data_path ~/Downloads/ --detection_method "$name" --dataset dfdc > "dfdc_${name}.txt"
done
